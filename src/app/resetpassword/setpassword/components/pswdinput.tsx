 ...
 */
export function PasswordInput({ pswd, onSetPassword }: inputProp) {
  ...
  return (
    <div className="flex flex-col w-full relative">
      ...
      <input
        ...
        className={`w-full pr-16 p-3 rounded-2xl border ${
          !isValid
      ...
      <button
        className="absolute right-4 top-[45%] -translate-y-1/2 text-orange-500 font-semibold hover:text-orange-700 transition-colors duration-200"
        type="button"
